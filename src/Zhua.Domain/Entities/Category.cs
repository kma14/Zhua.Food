...
/// <summary>
/// A node in the cross-store category tree (Department → Aisle → Shelf) — plan D22.
...
public class Category
{
    ...
    /// and the <see cref="Category"/> is owned curation, so the mapper never un-archives it — that's how a
    ...
    /// <summary>Per-store categories mapped to this item node (Foodstuffs by identity, others fuzzy — D22).</summary>
